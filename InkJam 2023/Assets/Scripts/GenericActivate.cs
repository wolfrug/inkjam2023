...
[System.Serializable]
public class Activated : UnityEvent<GameObject, GenericActivate> { }

[System.Serializable]
public class ActivateStarted : UnityEvent<GameObject, GenericActivate> { };

[System.Serializable]
public class ActivateCancelled : UnityEvent<GameObject, GenericActivate> { };
public class GenericActivate : MonoBehaviour
{
    ...
    public void TriggerDeactivate(GameObject dynamic)
    {
        if (enabled)
        {
            MakeVisible(false, dynamic);
        };
    }

    public void MakeVisible(bool visible, GameObject activatingAgent)
    {
        if (enabled)
        {
    ...
    public void AddActivations(int amount)
    { // use this to either stop a permanent activation thing, or to re-activate a de-activated thing
